  ...
  void _handleSignup() async {
    ...
    try {
      await _authService.signUpWithEmail(
        ...
        _nameController.text.trim().isEmpty ? 'Explorer' : _nameController.text.trim(),
      );
                    ...
                    TextButton(
                      ...
                      child: const Text.rich(
                        TextSpan(
                          ...
                          style: TextStyle(color: AppTheme.textMuted),
                          children: [
                            TextSpan(text: "Login", style: TextStyle(color: AppTheme.secondary, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                    ),
